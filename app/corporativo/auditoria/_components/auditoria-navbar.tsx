...
const auditoriaNavigation = [
  { name: "Auditoria de Campo", href: "/corporativo/auditoria/campo", icon: FileSearch },
  { name: "Compliance & Processos", href: "/corporativo/auditoria/compliance", icon: ShieldCheck },
]

export function AuditoriaNavbar() {
