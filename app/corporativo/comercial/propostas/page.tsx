...
import { AlertCircle, CheckCircle2, Clock, Lock, Save, Send, ChevronDown, ChevronUp } from "lucide-react"
...
// ============================================================================
// COMPONENT - PROPOSTAS (ANÁLISE CORPORATIVA)
// ============================================================================
...
export default function PropostasPage() {
  ...
  const [proposta] = useState<PropostaCompleta>({
    ...
    analiseViabilidade: {
      pilares: {
        tecnica: { score: 8, comentario: "Capacidade técnica comprovada em obras similares" },
        operacional: { score: 7, comentario: "Equipe disponível com experiência em pontes" },
        financeira: { score: 9, comentario: "Capital de giro adequado para obra deste porte" },
        economica: { score: 6, comentario: "Margem aceitável considerando competitividade" },
        juridica: { score: 8, comentario: "Sem restrições jurídicas identificadas" },
        risco: { score: 7, comentario: "Riscos gerenciáveis com plano de mitigação" },
      },
      conclusao: "viavel",
      observacoes: "Projeto estratégico, alinhado com metas corporativas de infraestrutura",
    },
    analiseJuridica: {
      ...
      parecer: "Contrato dentro dos padrões de mercado. Todas as cláusulas estão em conformidade com a legislação vigente.",
      status: "seguro",
    },
    analiseRisco: {
      riscos: [
        {
          ...
          impacto: 4,
          classificacao: "medio",
          mitigacao: "Iniciar processos com 6 meses de antecedência",
        },
        {
          id: "R2",
          descricao: "Variação cambial em insumos importados",
          categoria: "financeiro",
          probabilidade: 2,
          impacto: 3,
          classificacao: "baixo",
          mitigacao: "Hedge cambial para materiais críticos",
        },
      ],
      matrizResumo: { baixo: 1, medio: 1, alto: 0, critico: 0 },
    },
  ...
  return (
    <div className="flex h-screen bg-muted/30">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <ComercialTopBar titulo="Propostas & Análise Corporativa" />

        {/* HEADER FIXO DA PROPOSTA */}
          ...
          <Tabs defaultValue="analise" className="h-full">
            <div className="sticky top-0 z-10 bg-background border-b px-4">
              <TabsList className="h-12">
                ...
                <TabsTrigger value="decisao" className="gap-2">
                  Decisão
                </TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="analise" className="p-4 space-y-4 m-0">
              ...
              {/* LINHA COMPLETA: Matriz de Risco */}
            ...
            <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Registre a decisão sobre esta proposta
                    </p>
              </CardHeader>
