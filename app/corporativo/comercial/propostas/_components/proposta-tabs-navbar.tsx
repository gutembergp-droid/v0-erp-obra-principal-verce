...
interface PropostaTabsNavbarProps {
  activeTab: string
...
const tabs = [
  ...
  { value: "analise", label: "Análise ABC", icon: BarChart3 },
  { value: "plano", label: "Plano Vendas", icon: Lightbulb },
  { value: "economico", label: "Cenário Econ.", icon: Calculator },
  { value: "tecnico", label: "Técnica", icon: Wrench },
  { value: "operacional", label: "Operacional", icon: Truck },
  { value: "riscos", label: "Riscos", icon: AlertTriangle },
  { value: "sintese", label: "Síntese", icon: CheckCircle2 },
]

export function PropostaTabsNavbar({ activeTab, onTabChange }: PropostaTabsNavbarProps) {
  return (
          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group relative flex items-center gap-1.5 px-5 py-3 text-sm font-bold whitespace-nowrap",
