    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold">Central de Pagamento</h1>
          <p className="text-muted-foreground">Consolidacao e pagamento de todas as folhas</p>
        </div>
...
export default function PagamentoCorporativoPage() {
  return (
    <Suspense fallback={<div className="p-6">Carregando...</div>}>
      <PagamentoCorporativoContent />
    </Suspense>
  )
}
