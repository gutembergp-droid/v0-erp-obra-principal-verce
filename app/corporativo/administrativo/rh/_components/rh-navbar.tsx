...
const rhNavigation = [
  { name: "Visão Geral", href: "/corporativo/administrativo/rh", icon: LayoutDashboard },
  { name: "Pessoas", href: "/corporativo/administrativo/rh/pessoas", icon: Users },
  { name: "Ponto", href: "/corporativo/administrativo/rh/ponto", icon: Clock },
  { name: "Pagamento", href: "/corporativo/administrativo/rh/pagamento", icon: DollarSign },
  { name: "Terceirizados", href: "/corporativo/administrativo/rh/terceirizados", icon: HardHat },
  { name: "Conformidade", href: "/corporativo/administrativo/rh/conformidade", icon: ShieldAlert },
  { name: "Analytics", href: "/corporativo/administrativo/rh/analytics", icon: BarChart3 },
  { name: "Prévia Folha", href: "/corporativo/administrativo/rh/previa-folha", icon: FileText },
  { name: "Consolidação", href: "/corporativo/administrativo/rh/consolidacao", icon: FileCheck },
  { name: "Convenções", href: "/corporativo/administrativo/rh/convencoes", icon: Gavel },
]
      ...
      <div className="w-[calc(100%-32px)] ml-4 px-[10px] overflow-hidden">
        <nav className="flex items-end justify-start gap-1 pt-3 pb-0 overflow-hidden relative z-10" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {rhNavigation.map((item) => {
            ...
            let isActive = false
            if (item.href === "/corporativo/administrativo/rh") {
              isActive = pathname === "/corporativo/administrativo/rh"
            } else {
