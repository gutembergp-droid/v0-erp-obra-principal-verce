...
import { HardHat, TreePine } from "lucide-react"

const qsmsNavigation = [
  { name: "Qualidade & Segurança", href: "/corporativo/qsms/qualidade", icon: HardHat },
  { name: "Meio Ambiente & Social", href: "/corporativo/qsms/meio-ambiente", icon: TreePine },
]

export function QSMSNavbar() {
