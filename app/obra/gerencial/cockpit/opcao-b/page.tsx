...
// Card Fluxo de Caixa MINI (adicional - 5o card)
function FluxoCaixaMiniCard() {
  return (
    <Card className="bg-card border-border">
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-2">
          <span className="text-xs text-muted-foreground">Fluxo Caixa</span>
          <Wallet className="h-4 w-4 text-muted-foreground" />
        </div>
        <div className="text-xl font-bold text-foreground mb-2">R$ 400K</div>
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              <ArrowUpRight className="h-3 w-3 text-emerald-600" />
              <span className="text-xs text-emerald-600">2.8M</span>
            </div>
            <div className="flex items-center gap-1">
              <ArrowDownRight className="h-3 w-3 text-red-600" />
              <span className="text-xs text-red-600">2.4M</span>
            </div>
          </div>
          <div className="h-2 bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-400" style={{ width: "60%" }} />
          </div>
          <div className="flex justify-between items-center">
    ...
    <div className="h-full overflow-auto bg-background">
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">5 cards financeiros (adiciona Fluxo Caixa)</p>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={() => router.push("/obra/gerencial/cockpit/opcao-a")}>
                Opcao A
              </Button>
              <Button variant="default" size="sm" onClick={() => router.push("/obra/gerencial/cockpit/opcao-b")}>
                Opcao B
              </Button>
        ...
        <div className="space-y-4">
          ...
          {/* KPIs Internos - OPCAO B: 5 cards (4 + Fluxo Caixa Mini) */}
...
export default function CockpitOpcaoBPage() {
  return (
    <Suspense fallback={null}>
      <CockpitOpcaoBContent />
    </Suspense>
  )
}
