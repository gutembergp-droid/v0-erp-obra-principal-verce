        ...
        <main className="flex-1 bg-background overflow-hidden p-6">
          <div
            ...
            style={{
              borderRadius: "25px",
              boxShadow:
                "inset 0 0 10px rgba(0, 0, 0, 0.13), 0 2px 8px rgba(0, 0, 0, 0.05)",
              scrollbarWidth: "none",
                        ...
                        <CardContent className="p-0">
                          ...
                          <ScrollArea className="h-[400px]">
                            {apropriacoes.map((item) => (
                              <div
                                key={item.id}
                                className={`grid grid-cols-8 gap-2 px-4 py-3 border-b hover:bg-muted/50 cursor-pointer transition-colors ${selectedApropriacao?.id === item.id ? "bg-amber-50 border-l-4 border-l-amber-500" : ""
                                  }`}
