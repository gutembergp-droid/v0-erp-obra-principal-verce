...
import { FileText, Send, CheckCircle2, AlertCircle, Download, Upload, Eye, ChevronRight } from "lucide-react"
  ...
  const getStatusBadge = () => {
    switch (status) {
      ...
      case "em_estruturacao":
        return <Badge className="bg-amber-500/20 text-amber-600 border-amber-500/30">Em Estruturação</Badge>
      case "revisado":
        return <Badge className="bg-blue-500/20 text-blue-600 border-blue-500/30">Revisado</Badge>
      case "homologado":
        return <Badge className="bg-emerald-500/20 text-emerald-600 border-emerald-500/30">Homologado</Badge>
    }
  }
  ...
  return (
    <AppLayout>
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="flex-none border-b border-border/40 bg-card/30 px-6 py-4">
