...
import { FileText, CheckCircle2, AlertTriangle, XCircle, Link2, Send, Shield, Info, ChevronLeft } from "lucide-react"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-xl font-semibold text-foreground">Estruturação da Medição</h1>
                ...
                <p className="text-xs text-muted-foreground mt-1">Planilha de medição e critérios de avanço</p>
              </div>
            </div>
